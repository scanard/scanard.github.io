...
/// Indice
const indices = [
    "Hint 1 : You should try coding the letters string thanks to the board and attempt to find the inital coordinates.",
    "Hint 2 : The given key must be used to divide a coordinates lign in order to find the initial coordinates.",
];
