...
document.getElementById('signerButton').addEventListener('click', function() {
    ...
    document.getElementById('vérifsignerButton').style.display = 'block';
    currentDialog=4;
    startDialogSequence();
});
...
/// Validation + dialogue
document.getElementById('vérifsignerButton').addEventListener('click', function() {
    var messageInput = document.getElementById('messageInput').value;
    if (messageInput.toUpperCase() === 'AGENT AU RAPPORT') {
        currentDialog = 6;
        startDialogSequence();
    } else {
...
closeAllBtns.forEach((btn) => {
    ...
    currentDialog = 0;
    window.location.href = "../salle 10/salle10.html?playerName="+ encodePlayerName;
    });
});
