...
/// Indice
const indices = [
  "Hint 1 : That letter string looks like it can be cut in blocks.",
  "Hint 2 : Each block must then be transformed in a new one thanks to the equations in the box.",
];
...
document.getElementById('useButton').addEventListener('click', function() {
  if (indiceIndex < indices.length) {
      ...
      alert("Every hints have been used1;");
  }
